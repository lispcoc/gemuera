...
#pragma warning restore CS0162 // 到達できないコードが検出されました
	...
	private sealed class TOOLTIP_SETCOLOR_Instruction : AInstruction
	{
		...
		public override void DoInstruction(ExpressionMediator exm, InstructionLine func, ProcessState state)
		{
			...
			EraColor fc = EraColor.FromArgb((int)foreColor >> 16, (int)foreColor >> 8 & 0xFF, (int)foreColor & 0xFF);
			EraColor bc = EraColor.FromArgb((int)backColor >> 16, (int)backColor >> 8 & 0xFF, (int)backColor & 0xFF);
