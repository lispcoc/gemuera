...
internal sealed class ConfigItem<T> : AConfigItem
{
	...
	public override string ValueToString()
	{
		...
		if (this is ConfigItem<EraColor>)
		{
			EraColor c = ((ConfigItem<EraColor>)(AConfigItem)this).Value;
	...
	public override bool TryParse(string param)
	{
		...
		else if (this is ConfigItem<EraColor>)
		{
			EraColor c;
			ret = tryStringsToColor(str, out c);
			if (ret)
				((ConfigItem<EraColor>)(AConfigItem)this).Value = c;
			else
	...
	private static bool tryStringsToColor(string str, out EraColor c)
	{
