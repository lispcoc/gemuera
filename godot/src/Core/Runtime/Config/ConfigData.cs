...
internal sealed class ConfigData
{
	...
	private void setDefault()
	{
		...
		configArray.Add(new ConfigItem<EraColor>(ConfigCode.ForeColor, "文字色", "Text EraColor", EraColor.FromArgb(192, 192, 192)));//LIGHTGRAY
		configArray.Add(new ConfigItem<EraColor>(ConfigCode.BackColor, "背景色", "Background EraColor", EraColor.FromArgb(0, 0, 0)));//BLACK
		configArray.Add(new ConfigItem<EraColor>(ConfigCode.FocusColor, "選択中文字色", "Highlight EraColor", EraColor.FromArgb(255, 255, 0)));//YELLOW
		configArray.Add(new ConfigItem<EraColor>(ConfigCode.LogColor, "履歴文字色", "History log EraColor", EraColor.FromArgb(192, 192, 192)));//LIGHTGRAY//EraColor.FromArgb(128, 128, 128));//GRAY
		...
		configArray.Add(new ConfigItem<EraColor>(ConfigCode.RikaiColorBack, "ポップアップの背景色", "Rikai- Back EraColor", EraColor.FromArgb(0, 0, 0x8B))); ////EraColor.DarkBlue
		configArray.Add(new ConfigItem<EraColor>(ConfigCode.RikaiColorText, "ポップアップの文字色", "Rikai- Text EraColor", EraColor.FromArgb(0xFF, 0xFF, 0xFF))); ////EraColor.White
	...
	private void setDefault()
	{
		...
		configArray[i++] = new ConfigItem<EraColor>(ConfigCode.ForeColor, "文字色", EraColor.FromArgb(192, 192, 192));//LIGHTGRAY
		configArray[i++] = new ConfigItem<EraColor>(ConfigCode.BackColor, "背景色", EraColor.FromArgb(0, 0, 0));//BLACK
		configArray[i++] = new ConfigItem<EraColor>(ConfigCode.FocusColor, "選択中文字色", EraColor.FromArgb(255, 255, 0));//YELLOW
		configArray[i++] = new ConfigItem<EraColor>(ConfigCode.LogColor, "履歴文字色", EraColor.FromArgb(192, 192, 192));//LIGHTGRAY//EraColor.FromArgb(128, 128, 128);//GRAY
	...
	public static SingleTerm GetConfigValueInERB(string text, ref string errMes)
	{
		...
		switch (item.Code)
		{
			...
			case ConfigCode.LogColor://"履歴文字色"
				{
					EraColor EraColor = item.GetValue<EraColor>();
					term = new SingleLongTerm(((EraColor.R * 256) + EraColor.G) * 256 + EraColor.B);
				}
				break;
