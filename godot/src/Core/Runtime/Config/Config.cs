...
internal static class Config
{
	...
	public static void SetConfig(ConfigData instance)
	{
		...
		ForeColor = instance.GetConfigValue<EraColor>(ConfigCode.ForeColor);
		BackColor = instance.GetConfigValue<EraColor>(ConfigCode.BackColor);
		FocusColor = instance.GetConfigValue<EraColor>(ConfigCode.FocusColor);
		LogColor = instance.GetConfigValue<EraColor>(ConfigCode.LogColor);
		...
		RikaiColorBack = instance.GetConfigValue<EraColor>(ConfigCode.RikaiColorBack);
		RikaiColorText = instance.GetConfigValue<EraColor>(ConfigCode.RikaiColorText);
		...
		if (FontSize < 8)
		{
			// [Gemuera] dialog suppressed in headless build
			FontSize = 8;
		}
	...
	public static EraColor ForeColor { get; private set; }
	public static EraColor BackColor { get; private set; }
	public static EraColor FocusColor { get; private set; }
	public static EraColor LogColor { get; private set; }
	...
	public static EraColor RikaiColorBack { get; private set; }
	public static EraColor RikaiColorText { get; private set; }
